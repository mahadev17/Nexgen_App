...
public class ViewerForgotPassword extends Activity {
	...
	public class ForgotpaaswordTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... arg0) {
			String url = Constant.serverURL + "method=ViewerForgotPassword&email="+forgotEmail;
		...
		protected void onPostExecute(String result) {
			...
			if(result.contains("-1")){
				...
				Intent LoginIntent=new Intent(getApplicationContext(),FestivalViewer.class);
