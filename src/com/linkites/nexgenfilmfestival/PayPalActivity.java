...
import com.linkites.Constant.ResultDelegate;
...
public class PayPalActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//if(bundleValue!=null){
			//prize = bundleValue.getString("prize");
			prize="2.0";
			packages = "Registration";
			
		//}
		//prize="2.0";
		//prizePackage.setText("Have the complete access to My Ax Collection for a week in just $4.50.");
		...
		appVersion.setText("Build " + PayPal.getBuild());
	...
	private PayPalPayment exampleSimplePayment() {
    	...
    	payment.setSubtotal(new BigDecimal(prize));
    	...
    	payment.setMerchantName("Nex Gen Film");
